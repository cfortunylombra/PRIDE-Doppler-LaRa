...
if __name__=="__main__":
    ...
    observation_simulators = observations.create_observation_simulators(two_way_doppler_observation_settings,bodies) 
    ...
    observation_simulation_settings = observations.create_tabulated_simulation_settings(
        dict({observations.two_way_doppler_type:observation_settings_list}),observation_times_list) #observations.two_way_doppler_type NOTE
    ...
    observations.add_viability_check_to_settings(observation_simulation_settings,viability_settings_list) 
    ...
    weights_per_observable = dict({observations.two_way_doppler_type:doppler_noise**(-2)}) #observations.two_way_doppler_type NOTE

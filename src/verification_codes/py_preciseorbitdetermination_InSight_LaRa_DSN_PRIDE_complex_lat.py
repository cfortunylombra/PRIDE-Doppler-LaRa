"""
Description: Check latitude changes
...
if __name__=="__main__":
    ...
    if LaRa_boolean:
        output_folder_path = os.path.dirname(os.path.realpath(__file__)).replace('/src','/output/latLaRa_POD_RISE'+str(RISE_boolean)+'_LaRa'+str(LaRa_boolean)+'_PRIDEcomplex'+str(PRIDE_boolean)+str(remove_PRIDE_weight_boolean))
    else:
        output_folder_path = os.path.dirname(os.path.realpath(__file__)).replace('/src','/output/latLaRa_POD_RISE'+str(RISE_boolean)+'_LaRacomplex'+str(LaRa_boolean))

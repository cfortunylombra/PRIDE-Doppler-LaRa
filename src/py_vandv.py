...
if __name__=="__main__":
    ...
    xposition = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/xposition_vandv.dat"))
    yposition = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/yposition_vandv.dat"))
    zposition = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/zposition_vandv.dat"))
    xdotvelocity = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/xdotvelocity_vandv.dat"))
    ydotvelocity = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/ydotvelocity_vandv.dat"))
    zdotvelocity = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/zdotvelocity_vandv.dat"))
    corefactor = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/corefactor_vandv.dat"))
    sigmaFCN = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/sigmaFCN_vandv.dat"))
    xLaRa = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/xLaRa_vandv.dat"))
    yLaRa = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/yLaRa_vandv.dat"))
    zLaRa = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/zLaRa_vandv.dat"))
    cos1spin = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/cos1spin_vandv.dat"))
    sin1spin = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/sin1spin_vandv.dat"))
    cos2spin = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/cos2spin_vandv.dat"))
    sin2spin = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/sin2spin_vandv.dat"))
    cos3spin = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/cos3spin_vandv.dat"))
    sin3spin = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/sin3spin_vandv.dat"))
    cos4spin = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/cos4spin_vandv.dat"))
    sin4spin = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/sin4spin_vandv.dat"))
    xpcos1 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/xpcos1_vandv.dat"))
    xpsin1 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/xpsin1_vandv.dat"))
    ypcos1 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/ypcos1_vandv.dat"))
    ypsin1 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/ypsin1_vandv.dat"))
    xpcos2 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/xpcos2_vandv.dat"))
    xpsin2 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/xpsin2_vandv.dat"))
    ypcos2 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/ypcos2_vandv.dat"))
    ypsin2 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/ypsin2_vandv.dat"))
    xpcos3 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/xpcos3_vandv.dat"))
    xpsin3 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/xpsin3_vandv.dat"))
    ypcos3 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/ypcos3_vandv.dat"))
    ypsin3 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/ypsin3_vandv.dat"))
    xpcos4 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/xpcos4_vandv.dat"))
    xpsin4 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/xpsin4_vandv.dat"))
    ypcos4 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/ypcos4_vandv.dat"))
    ypsin4 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/ypsin4_vandv.dat"))
    xpcos5 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/xpcos5_vandv.dat"))
    xpsin5 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/xpsin5_vandv.dat"))
    ypcos5 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/ypcos5_vandv.dat"))
    ypsin5 = np.loadtxt(os.path.dirname(os.path.realpath(__file__)).replace('/src',"/output/vandv/ypsin5_vandv.dat"))

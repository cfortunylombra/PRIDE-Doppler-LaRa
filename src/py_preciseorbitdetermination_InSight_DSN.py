...
if __name__=="__main__":
    ...
    concatenated_observations[:] = np.array([concatenated_observations[i] for i in index_sort])
    ...
    np.savetxt(output_folder_path+"/concatenated_observations_sort.dat",concatenated_observations,fmt='%.15e')
